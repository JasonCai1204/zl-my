...
<div class="my_home_footer">
    <div class="weui-tabbar" id="my_footer_tabber">
        <a href="/" class="weui-tabbar__item my_tabbar_click">
            <img src="/storage/images/user/user-mobile-item-index.png" alt="" class="weui-tabbar__icon">
            <p class="weui-tabbar__label">首页</p>
        </a>
        <a href="news" class="weui-tabbar__item">
            <img src="/storage/images/user/user-mobile-item-advice.png" alt="" class="weui-tabbar__icon">
            <p class="weui-tabbar__label">资讯</p>
        </a>
        <a href="recommends" class="weui-tabbar__item">
            <img src="/storage/images/user/user-mobile-item-recommend.png" alt="" class="weui-tabbar__icon">
            <p class="weui-tabbar__label">推荐</p>
        </a>
        <a href="account" class="weui-tabbar__item">
            <img src="/storage/images/user/user-mobile-item-account.png" alt="" class="weui-tabbar__icon">
